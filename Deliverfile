...
app_identifier "com.snap.connectedcare.EpicMDProduction" # The bundle identifier of your app
apple_id "1078916712" # This is NOT your Apple login ID, but the App ID of your app
email "snapmd@rinsoft.com" # the login email address
